    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edt_symp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String[] arr1 = new String[]{"无症状", "头痛头晕", "恶心呕吐", "眼花耳鸣", "呼吸困难",
                        "心悸胸闷", "鼻衄出血不止", "四肢发麻", "下肢水肿"};
                final boolean[] arrSelected1 = new boolean[]{false, false, false, false, false,
                        false, false, false, false};
                Dialog alertdialog_symp = new AlertDialog.Builder(hypertension.this)
        ...
        edt_mode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog alertdialog_mode = new AlertDialog.Builder(hypertension.this)
        ...
        edt_psycho.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog alertdialog_psycho = new AlertDialog.Builder(hypertension.this)
        ...
        edt_doct.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog alertdialog_doct = new AlertDialog.Builder(hypertension.this)
        ...
        edt_medicine.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog alertdialog_medicine = new AlertDialog.Builder(hypertension.this)
        ...
        edt_assess.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Dialog alertdialog_assess = new AlertDialog.Builder(hypertension.this)
